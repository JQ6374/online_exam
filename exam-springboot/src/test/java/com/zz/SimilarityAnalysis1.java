...
public class SimilarityAnalysis1 {
    public static void main(String[] args) {
        System.out.println(calculateSimilarityScore(
                "这是一个样本段落。它包含几个句子。每个句子都是用句号分隔的。",
                "这是一个样本段落。句子"));
    }
    public static int calculateSimilarityScore(String correctAnswer, String studentAnswer) {
        ...
        int totalScore = 100;
        int studentScore = (int) (maxSimilarity * totalScore);
