...
public interface ExamDao {
    ...
    //    修改信息
    @Update("UPDATE exam set u_id=#{uId},c_id=#{cId},p_id=#{pId},name=#{name},start_time = #{startTime}," +
